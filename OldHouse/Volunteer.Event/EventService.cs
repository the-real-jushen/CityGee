...
namespace Jtext103.Volunteer.VolunteerEvent
{
    ...
    {
        public static IRepository<Event> eventRepository;
        public static IRepository<Subscriber> subscriberRepository;
        ...
        public static void InitService(IRepository<Event> eventRepository, IRepository<Subscriber> subscriberRepository, int sleepTimeBetweenEvents, int sleepTimeBetweenQueues, List<IVolunteerEventHandler> handlers)
        {
            EventService.eventRepository = eventRepository;
            EventService.subscriberRepository = subscriberRepository;
            EventService.sleepTimeBetweenEvents = sleepTimeBetweenEvents;
        ...
        public static void Publish(string eventType, object subject, object eventSender)
        {
            Event newEvent = new Event(eventType, subject, eventSender);
